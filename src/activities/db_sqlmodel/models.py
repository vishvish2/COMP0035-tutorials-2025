...
class Games(SQLModel, table=True):
    ...
    games_teams: List["GamesTeam"] = Relationship(
        back_populates="games", cascade_delete=True
        )
    games_disabilities: List["GamesDisability"] = Relationship(
        back_populates="games", cascade_delete=True
        )
    games_hosts: List["GamesHost"] = Relationship(
        back_populates="games", cascade_delete=True
        )
...
class GamesDisability(SQLModel, table=True):
    ...
    disability: Optional[Disability] = Relationship(
        back_populates="games_disabilities"
        )
